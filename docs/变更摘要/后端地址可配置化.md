...
*   **核心变更:**
    *   ✨ 移除所有硬编码的后端服务器地址
    *   🔧 新增 [ConfigManager](../../android_app/app/src/main/java/com/example/agentchat/ConfigManager.kt) 统一管理配置
...
**修改文件:** [ConversationsActivity.kt](../../android_app/app/src/main/java/com/example/agentchat/ConversationsActivity.kt)
